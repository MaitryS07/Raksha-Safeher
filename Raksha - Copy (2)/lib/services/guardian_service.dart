...
class GuardianService {
  ...
  static const String _baseUrl = 'http://192.168.17.116:5000'; // ← your Flask server IP:port
  ...
  Future<bool> addGuardian(Guardian guardian) async {
    ...
    try {
      ...
      if (response.statusCode == 200 || response.statusCode == 201) {
        ...
        debugPrint('Guardian added successfully: ${guardian.phone}');
        return true;
      } else {
        debugPrint('Backend rejected guardian: ${response.statusCode} - ${response.body}');
        return false;
      }
    } catch (e) {
